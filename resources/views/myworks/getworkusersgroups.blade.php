...
<label class='label'>Найдено: <b>{{ $work->count }}</b> сообществ</label>
<textarea class="output-panel form-control mb-2"  id="textarea" rows="13">@forelse($data as $key => $value){{$key}}
