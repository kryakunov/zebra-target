...
@section('title', 'Цены и тарифы парсера ВКонтакте — Зебра Таргет')
@section('description', 'Тарифы Зебра Таргет: полный доступ к парсингу аудитории ВКонтакте, мониторингу сообществ и работе с базами пользователей.')

@section('content')
<div class="tab">
<h1 class="title">Цены и тарифы</h1>
<div class="content">

@include('errors.session')

<p>Полный доступ открывает безлимитный парсинг, мониторинг сообществ и больше сохранённых баз. Страницу тарифов можно читать без входа; оплата и кабинет — только для авторизованных пользователей.</p>
...
<div class="alert alert-warning" role="alert">
  Временно не работает онлайн-касса, для оплаты напишите мне в личные сообщения  <a href="<?php echo PAY_URL; ?>" target="_blank"><b>Во Вконтакте</b></a>
</div>
...
<div class="row">
   ...
   <div class='tab-title-price'><?=$ORDER_AMOUNT1?><br><span class='priceAbout'>руб / 1 месяц</span></div>
      ...
      <div class='tab-title-price-bottom'>
         <form method='get' action="<?php echo PAY_URL; ?>">
         ...
         <a href="<?php echo PAY_URL; ?>" target="_blank"><button class="btn btn-warning" <?php if (!session('id')) echo 'disabled'; ?>>Оплатить</button></a>
      </div>
   </div>
   <div class="col-md-3">
...
<hr>
Если вы не нашли подходящего способа оплаты — напишите в личные сообщения <a href="https://vk.ru/im?sel=185466160" target="_blank">ВКонтакте</a>

<h2>Частые вопросы</h2>
<h3>Можно ли смотреть тарифы без входа?</h3>
<p>Да. Страница тарифов открыта. Оплата и доступ к кабинету — после входа через ВКонтакте.</p>
<h3>Что даёт полный доступ?</h3>
<p>Безлимитный парсинг, больше слотов мониторинга групп и сохранённых баз. Точные лимиты указаны в карточках тарифов.</p>
