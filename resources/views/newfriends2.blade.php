...
@include('errors.exceptions')
    ...
    <div class="for-mobile mb-3">
        <a class="btn btn-outline-success btn-sm p-2" style="margin-bottom: 10px; width: 100%" href="{{route('NewFriendsCreate')}}" onlick="ym(61877542,'reachGoal','click', {URL: document.location.href}); return true;)">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5"/>
            </svg>
            Добавить пользователей</a>
        @if(session('access') !== null)<a class="btn btn-success btn-sm p-2" style="margin-bottom: 10px; width: 100%"  href="{{route('NewFriendsUpdate')}}">
