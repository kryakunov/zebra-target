...
class UsersAllGroupsController extends ExecController
{
    public function __construct()
    {
        $this->time = time();
        $this->type = 19;
        $this->execScriptName = 'execUsersAllGroups';
    } 
    ...
    public function index()
    {
		...
		if ($work) {
			return view('usersallgroups', ['work' => $work]);
		}

        return view('usersallgroups');
    }
