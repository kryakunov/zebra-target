...
class GetPromoPostsController extends ExecController
{
    ...
    public function __construct()
    {
        $this->time = time();
        $this->type = 16;
        $this->execScriptName = 'execGetPromoPosts';
    } 
    ...
    public function show()
    {
		...
		if ($work) {
			return view('getpromoposts', ['work' => $work]);
		}


        return view('getpromoposts');
    }
    ...
    public function handler(Request $request)
    {
        ...
        ($request->get('name')) ? $name = $request->get('name') : $name = 'Без названия | Поиск промо-постов';
