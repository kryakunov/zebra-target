...
class SocialNetworks extends Execute
{
    public $file;
    public $id;
    public $access_token;
    ...
    public function parse($users)
    {
        ...
        foreach($temp as $value)
        {
            ...
            $this->setState('Ищу соц. сети ['.$cc++.'/'.$count.']');
    ...
    public function getSocialNetworks($users, $request)
    {
        ...
        foreach($users as $user)
        {
            ...
            if (isset($user['instagram']) and isset($request['instagram'])) $data['instagram'][] = $user['instagram'];
            if (isset($user['skype'])and isset($request['skype']))  $data['skype'][] = $user['skype'];
            if (isset($user['twitter']) and isset($request['twitter']))  $data['twitter'][] = $user['twitter'];
            if (isset($user['facebook']) and isset($request['facebook']))  $data['facebook'][] = $user['facebook'];
        }
