...
class GetFriends extends Exec
{
    ...
    public function getFriends($users)
    {
        ...
        foreach($users as $user)
        {
            ...
            $percent = round(($this->allCount / $countUsers) * 100 / $this->checked) ;
            ...
            // Делаем запрос
            $result = $this->vkapi('execute.getFriends', $request_params);
    ...
    public function getFollowersAll($repeatParse, $followersCount)
    {
        ...
        for($i = 0; $i < $count; $i++)
        {
            ...
            do {
                ...
                $result = $this->vkapi('execute.getFollowersUser', $request_params);
    ...
    public function getFollowers($users)
    {
        ...
        foreach($users as $user)
        {
            ...
            $result = $this->vkapi('execute.getFollowers', $request_params);
