...
class GetActivityPosts extends Exec
{
    public $file;
    public $id;
    public $access_token;
			...
			foreach($posts as $post) 
			{
				...
				if (isset($request['likes'])) 
				{
					...
					do {
						...
						// Отправляем запрос
						$result = $this->vkapi('likes.getList', $request_params);
				...
				if (isset($request['comments'])) 
				{
					...
					do {
						...
						// Отправляем запрос
						$result = $this->vkapi('wall.getComments', $request_params);
